...
def cal_test_rmse(model, criterion, device):
    test_set = STData(dataset_type="test", windows_size=params.windows_size, dir_path='./data/')
...
def cal_val_rmse(model, criterion, device):
    val_set = STData(dataset_type="validate", windows_size=params.windows_size, dir_path='./data/')
